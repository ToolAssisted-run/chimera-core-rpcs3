...
set(WB "-specs=${SR}/lib/musl-gcc.specs -fvisibility=hidden -mcmodel=large -mstack-protector-guard=global -fno-stack-protector -fno-pic -fno-pie -fcf-protection=none -DCHIMERA_NO_TLS -DSTBI_NO_THREAD_LOCALS -DZ_TLS= -DCHIMERA_CORE -Dthread_local= -D_Thread_local= -D__thread= -U__cpp_constinit -I/home/jaffar/chimera-core-rpcs3/waterbox -isystem /home/jaffar/chimera-core-rpcs3/waterbox/guest-include")
